...
import 'ShlokaPage.dart';

class ChapterPage extends StatefulWidget {
  final int ch;
  final GeetaChapters chapters;

  const ChapterPage({required Key key, required this.ch, required this.chapters})
      : super(key: key);
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  ...
                                  builder: (BuildContext context) {
                                    return ShlokaPage(
                                        sk: index + 1, ch: widget.ch, key: Key("value"), );
                                  }));
                        },
